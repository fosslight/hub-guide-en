...
## HTTP Status Code 
{: .left-bar-title } 
The following table provides the HTTP status codes and representative error types returned by the APIs. For detailed error information, check the API response.
...
<table style="width: 100%; table-layout: fixed;">
  <thead>
    <tr style="background-color: #F0F0F0; color: black; font-weight: bold;">
      ...
      <th scope="col" style="width: 55%; padding: 8px;">Representative Error Types</th>
    </tr>
  </thead>
  <tbody>
    <tr style="background-color: white;">
      <td style="text-align: center; vertical-align: top; padding: 8px;"><strong>200</strong></td>
      <td style="vertical-align: top; padding: 8px;">OK (Success)</td>
      <td style="vertical-align: top; padding: 8px;">API-specific response data</td>
    </tr>
    <tr style="background-color: white;">
      ...
      <td style="vertical-align: top; padding: 8px;">
        <ul class="description-list">
          ...
          <li>Missing multipart file parameter</li>
          <li>Bean Validation failure</li>
    ...
    <tr style="background-color: white;">
      ...
      <td style="vertical-align: top; padding: 8px;">
        <ul class="description-list">
          <li>No permission</li>
          <li>No project access permission (VIEW or EDIT)</li>
        </ul>
      </td>
    </tr>
    <tr style="background-color: white;">
    ...
    <tr style="background-color: white;">
      ...
      <td style="vertical-align: top; padding: 8px;">File size exceeded</td>
    </tr>
    <tr style="background-color: white;">
    ...
    <tr style="background-color: white;">
      ...
      <td style="vertical-align: top; padding: 8px;">
        <ul class="description-list">
          <li>Unknown error</li>
          <li>File ID generation failure</li>
        </ul>
      </td>
    </tr>
  </tbody>
