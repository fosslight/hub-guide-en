...
### SBOM Sheet
{: .specific-title}
- SBOM (Bill of Materials) is generated by collecting the Open Source information from each sheet in the FOSSLight Report.  
- As the SBOM is automatically filled in when exporting the FOSSLight Report from the Project in FOSSLight Hub, manual editing is not necessary.   
![sbom](./images/bom.png)  
      ...
      <tr>
        ...
        <td style="padding: 12px;">
          ...
          <div style="margin-left: 20px;">
            ...
            • Self-Check: For internal review and pre-verification, not for external distribution<br>
            • Contribution: For contributing or releasing source code
          </div>
        </td>
      </tr>
      <tr>
